...
import androidx.core.view.Windowpackage ua.lviv.maf
                ...
                try {
                    ...
                    for (i in 0 until array.length()) {
                        ...
                        allMatches.add(TournamentRow(
                            id = m.optString("id", "0"),
                            home_team_id = m.optString("home_team_id", "0"), // Беремо ID господарів
    away_team_id = m.optString("away_team_id", "0"), // Беремо ID гостей
